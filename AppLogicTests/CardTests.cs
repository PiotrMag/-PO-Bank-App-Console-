...
namespace AppLogicTests
{
    ...
    public class CardTests
    {
        ...
        public void CreditCardsAreEqualTest()
        {
            ...
            var card2 = new CreditCard("1234567890", client, true, 1250.12);
        ...
        {
            var client = new NaturalPerson("Jan Kowalski", "11312737254");
            var card = new CreditCard("1233567890", client, true, 1250.12);
            var card2 = new CreditCard("1234567890", client, true, 1250.12);
        ...
        public void CreditCardsAreNotEqualDifferentOwnersTest()
        {
            ...
            var card2 = new CreditCard("1234567890", client2, true, 1250.12);
            Assert.AreNotEqual(card, card2);
        }
        ...
        public void DebitCardsAreEqualTest()
        {
            ...
            var card2 = new DebitCard("1234567890", client, true, 1250.12);
            Assert.AreEqual(card, card2);
        }
        ...
        {
            var client = new NaturalPerson("Jan Kowalski", "11312737254");
            var card = new DebitCard("1233567890", client, true, 1250.12);
            var card2 = new DebitCard("1234567890", client, true, 1250.12);
            Assert.AreNotEqual(card, card2);
        }
        ...
        public void DebitCardsAreNotEqualDifferentOwnersTest()
        {
            ...
            var card = new DebitCard("1234567890", client, true, 1250.12);
            var client2 = new NaturalPerson("Adam Nowak", "11397737254");
            var card2 = new DebitCard("1234567890", client2, true, 1250.12);
            Assert.AreNotEqual(card, card2);
        }
        ...
        public void ATMCardsAreEqualTest()
        {
            ...
            var card2 = new ATMCard("1234567890", client, true, 1250.12);
            Assert.AreEqual(card, card2);
        }
        ...
        {
            var client = new NaturalPerson("Jan Kowalski", "11312737254");
            var card = new ATMCard("1233567890", client, true, 1250.12);
            var card2 = new ATMCard("1234567890", client, true, 1250.12);
            Assert.AreNotEqual(card, card2);
        }
        ...
        public void ATMCardsAreNotEqualDifferentOwnersTest()
        {
            ...
            var card = new ATMCard("1234567890", client, true, 1250.12);
            var client2 = new NaturalPerson("Adam Nowak", "11397737254");
            var card2 = new ATMCard("1234567890", client2, true, 1250.12);
            Assert.AreNotEqual(card, card2);
        }
        ...
        {
            var client = new NaturalPerson("Jan Kowalski", "11312737254");
            var card1 = new ATMCard("1234567890", client, true, 1250.12);
            var card2 = new CreditCard("1254367890", client, true, 1250.12);
            var card3 = new DebitCard("1234587690", client, true, 1250.12);
